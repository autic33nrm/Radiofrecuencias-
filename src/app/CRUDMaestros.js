...
export const MostrarListaManualidades = (Datos) => {
    if (Datos.length) {
        ...
        Datos.forEach(documento => {
            ...
            const li = `
                <li class="custom-list-group custom-list-group-item">
                    ...
                    <button class="custom-btn custom-btn-warning w-100 mb-2 botoneSinSesion Eliminar-Manualidad" data-id="${idDocumento}"> Eliminar </button>
                    <button class="custom-btn custom-btn-success w-100 mb-2 botoneSinSesion Actualizar-Manualidad" data-id="${idDocumento}" data-bs-toggle="modal" data-bs-target="#ActualizarManualidad"> Actualizar </button>
                </li>
            `;
            html += li;
        });
